...
class TestTask1(unittest.TestCase):
    ...
    def test_minimum_3_legal_files(self):
        """Có tối thiểu 3 file PDF/DOCX/MD/HTML trong data/landing/legal/"""
        legal_dir = DATA_DIR / "landing" / "legal"
        if not legal_dir.exists():
            self.skipTest("data/landing/legal/ chưa tồn tại")

        # Cho phép .pdf/.docx/.doc (file gốc) và .md/.html (file crawl từ web)
        valid_extensions = {".pdf", ".docx", ".doc", ".md", ".html", ".htm"}
